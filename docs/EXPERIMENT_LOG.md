...
| E025 | Entity history pays on the `W` / established-card slice the aggregate hid | E022 capacity + `f7_history`, seeds 42/1/2, slice `ProductCD=='W' and D1>=14` | slice **−0.012**; complement (`D1<14`) **+0.043**; product `W` +0.025; aggregate **+0.0066** | Hypothesis rejected, premise inverted — the weak `W` population is *new* cards (PR-AUC 0.211), not established ones (0.798). Features help there. E007/E017's null holds at their capacity, not at E022's. No promotion: ADR 0010 gates, backtests and ADR 0004's serving contract all unrun |
